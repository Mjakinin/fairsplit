...
import { 
  Utensils, ShoppingCart, Car, Building2, Ticket, Receipt, Users, 
  Trash2, Edit3, Coffee, Zap 
} from 'lucide-react';
        ...
        <div className="space-y-6 py-2">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <Avatar name={profile?.display_name || 'Unbekannt'} avatarEmoji={profile?.avatar_emoji} size="sm" />
          ...
          <div className="grid grid-cols-2 gap-2 pt-2">
            <button
              ...
              className="py-3 px-4 rounded-xl border border-dark-border bg-dark-elevated hover:bg-white/10 text-white font-semibold text-xs flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
            >
            ...
            <button
              ...
              className="py-3 px-4 rounded-xl border border-rose-500/30 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 font-semibold text-xs flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
            >
